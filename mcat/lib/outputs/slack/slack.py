...
from mcat.config.config import aws_logo, azure_logo, gcp_logo, square_logo_img
            ...
            blocks = [
                ...
                {"type": "divider"},
                {
                    ...
                    "elements": [
                        {
                            "type": "mrkdwn",
                            "text": f"Used parameters: `mcat {args}`",
                        }
                    ],
                },
                {"type": "divider"},
                {
                    ...
                    "accessory": {
                        "type": "button",
                        "text": {"type": "plain_text", "text": "mcat :slack:"},
                        "url": "https://join.slack.com/t/mcat-workspace/shared_invite/zt-1hix76xsl-2uq222JIXrC7Q8It~9ZNog",
                    },
                },
                {
                    "type": "section",
                    ...
                    "accessory": {
                        "type": "button",
                        "text": {"type": "plain_text", "text": "mcat :github:"},
                        "url": "https://github.com/mcat-cloud/mcat",
                    },
                },
                {
                    "type": "section",
                    "text": {
                        "type": "mrkdwn",
                        "text": "See all the things you can do with mcatPro",
                    },
                    "accessory": {
                        "type": "button",
                        "text": {"type": "plain_text", "text": "mcat Pro"},
                        "url": "https://mcat.pro",
                    },
                },
            ]
