...
from mcat.lib.outputs.output import Finding, Output
from mcat.lib.outputs.utils import parse_html_string, unroll_dict
...
<!DOCTYPE html>
    ...
    <title>mcat - The Handy Cloud Security Tool</title>
    </head>
    <body>
