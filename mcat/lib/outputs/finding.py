...
from mcat.config.config import mcat_version
from mcat.lib.check.models import Check_Report
from mcat.lib.logger import logger
from mcat.lib.outputs.common import (
    fill_common_finding_data,
    get_provider_data_mapping,
)
from mcat.lib.outputs.compliance.compliance import get_check_compliance
    ...
    def generate_output(
        ...
        try:
            ...
            output_data["finding_uid"] = (
                f"mcat-{provider.type}-{check_output.check_metadata.CheckID}-{output_data['account_uid']}-"
