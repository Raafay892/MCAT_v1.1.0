...
from mcat.config.config import output_file_timestamp
from mcat.providers.aws.lib.arn.models import ARN
from mcat.providers.common.models import ProviderOutputOptions
    ...
    def __init__(self, arguments, bulk_checks_metadata, identity):
        ...
        if (
            ...
            self.output_filename = (
                f"mcat-output-{identity.account}-{output_file_timestamp}"
            )
        else:
