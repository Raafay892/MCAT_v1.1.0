...
from mcat.lib.mutelist.mutelist import Mutelist

providers_path = "mcat.providers"
...
class Provider(ABC):
    ...
    def get_available_providers() -> list[str]:
        ...
        mcat_providers = importlib.import_module(providers_path)
        # Iterate over all modules found in the mcat_providers package
        for _, provider, ispkg in pkgutil.iter_modules(mcat_providers.__path__):
