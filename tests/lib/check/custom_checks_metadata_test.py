...
from mcat.lib.check.models import (
...
S3_BUCKET_LEVEL_PUBLIC_ACCESS_BLOCK_REMEDIATION_TERRAFORM = (
    "https://docs.mcat.com/checks/aws/s3-policies/bc_aws_s3_20#terraform"
)
...
class TestCustomChecksMetadata:
        ...
        assert parse_custom_checks_metadata_file(
            ...
            "Checks": {
                "compute_instance_public_ip": {
                    ...
                    "Remediation": {
                        "Code": {
                            "CLI": "https://docs.mcat.com/checks/gcp/google-cloud-public-policies/bc_gcp_public_2#cli-command",
                ...
                "apiserver_anonymous_requests": {
                    ...
                    "Remediation": {
                        "Code": {
                            ...
                            "NativeIaC": "https://docs.mcat.com/checks/kubernetes/kubernetes-policy-index/ensure-that-the-anonymous-auth-argument-is-set-to-false-1#kubernetes",
    ...
    def test_update_checks_metadata_one_field(self):
        updated_terraform = (
            "https://docs.mcat.com/checks/aws/s3-policies/bc_aws_s3_21/#terraform"
        )
