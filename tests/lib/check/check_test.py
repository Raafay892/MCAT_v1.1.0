...
from mcat.lib.check.check import (
...
from mcat.lib.check.models import load_check_metadata
from mcat.providers.aws.aws_provider import AwsProvider
...
expected_packages = [
    ModuleInfo(
        module_finder=FileFinder(
            "/root_dir/mcat/providers/azure/services/storage/storage_ensure_minimum_tls_version_12"
        ),
        name="mcat.providers.azure.services.storage.storage_ensure_minimum_tls_version_12.storage_ensure_minimum_tls_version_12",
        ispkg=False,
    ),
    ModuleInfo(
        module_finder=FileFinder(
            "/root_dir/mcat/providers/azure/services/storage/storage_key_rotation_90_days"
        ),
        name="mcat.providers.azure.services.storage.storage_key_rotation_90_days.storage_key_rotation_90_days",
        ispkg=False,
    ),
    ModuleInfo(
        module_finder=FileFinder(
            "/root_dir/mcat/providers/azure/services/storage/storage_ensure_private_endpoints_in_storage_accounts"
        ),
        name="mcat.providers.azure.services.storage.storage_ensure_private_endpoints_in_storage_accounts.storage_ensure_private_endpoints_in_storage_accounts",
        ispkg=False,
    ),
    ModuleInfo(
        module_finder=FileFinder(
            "/root_dir/mcat/providers/azure/services/storage/storage_ensure_soft_delete_is_enabled"
        ),
        name="mcat.providers.azure.services.storage.storage_ensure_soft_delete_is_enabled.storage_ensure_soft_delete_is_enabled",
        ispkg=False,
    ),
    ModuleInfo(
        module_finder=FileFinder("/root_dir/mcat/providers/azure/services/storage"),
        name="mcat.providers.azure.services.storage.storage_ensure_encryption_with_customer_managed_keys",
        ispkg=True,
    ),
    ModuleInfo(
        module_finder=FileFinder(
            "/root_dir/mcat/providers/azure/services/storage/storage_ensure_encryption_with_customer_managed_keys"
        ),
        name="mcat.providers.azure.services.storage.storage_ensure_encryption_with_customer_managed_keys.storage_ensure_encryption_with_customer_managed_keys",
        ispkg=False,
    ),
    ModuleInfo(
        module_finder=FileFinder(
            "/root_dir/mcat/providers/azure/services/sqlserver"
        ),
        name="mcat.providers.azure.services.sqlserver.sqlserver_tde_encrypted_with_cmk",
        ispkg=True,
    ),
    ModuleInfo(
        module_finder=FileFinder(
            "/root_dir/mcat/providers/azure/services/sqlserver/sqlserver_tde_encrypted_with_cmk"
        ),
        name="mcat.providers.azure.services.sqlserver.sqlserver_tde_encrypted_with_cmk.sqlserver_tde_encrypted_with_cmk",
        ispkg=False,
    ),
    ModuleInfo(
        module_finder=FileFinder(
        ...
        name="mcat.providers.azure.services.sqlserver.sqlserver_tde_encryption_enabled",
        ispkg=True,
    ),
    ModuleInfo(
        module_finder=FileFinder(
            "/root_dir/mcat/providers/azure/services/sqlserver/sqlserver_tde_encryption_enabled"
        ),
        name="mcat.providers.azure.services.sqlserver.sqlserver_tde_encryption_enabled.sqlserver_tde_encryption_enabled",
        ispkg=False,
    ),
    ModuleInfo(
        module_finder=FileFinder(
        ...
        name="mcat.providers.azure.services.sqlserver.sqlserver_auditing_retention_90_days",
        ispkg=True,
    ),
    ModuleInfo(
        module_finder=FileFinder(
            "/root_dir/mcat/providers/azure/services/sqlserver/sqlserver_auditing_retention_90_days"
        ),
        name="mcat.providers.azure.services.sqlserver.sqlserver_auditing_retention_90_days.sqlserver_auditing_retention_90_days",
        ispkg=False,
    ),
    ModuleInfo(
        module_finder=FileFinder(
        ...
        name="mcat.providers.azure.services.sqlserver.sqlserver_vulnerability_assessment_enabled",
        ispkg=True,
    ),
    ModuleInfo(
        module_finder=FileFinder(
            "/root_dir/mcat/providers/azure/services/sqlserver/sqlserver_vulnerability_assessment_enabled"
        ),
        name="mcat.providers.azure.services.sqlserver.sqlserver_vulnerability_assessment_enabled.sqlserver_vulnerability_assessment_enabled",
        ispkg=False,
    ),
    ModuleInfo(
        module_finder=FileFinder(
        ...
        name="mcat.providers.azure.services.sqlserver.sqlserver_va_periodic_recurring_scans_enabled",
        ispkg=True,
    ),
    ModuleInfo(
        module_finder=FileFinder(
            "/root_dir/mcat/providers/azure/services/sqlserver/sqlserver_va_periodic_recurring_scans_enabled"
        ),
        name="mcat.providers.azure.services.sqlserver.sqlserver_va_periodic_recurring_scans_enabled.sqlserver_va_periodic_recurring_scans_enabled",
        ispkg=False,
    ),
    ModuleInfo(
        module_finder=FileFinder(
        ...
        name="mcat.providers.azure.services.sqlserver.sqlserver_va_scan_reports_configured",
        ispkg=True,
    ),
    ModuleInfo(
        module_finder=FileFinder(
            "/root_dir/mcat/providers/azure/services/sqlserver/sqlserver_va_scan_reports_configured"
        ),
        name="mcat.providers.azure.services.sqlserver.sqlserver_va_scan_reports_configured.sqlserver_va_scan_reports_configured",
        ispkg=False,
    ),
    ModuleInfo(
        module_finder=FileFinder(
        ...
        name="mcat.providers.azure.services.sqlserver.sqlserver_va_emails_notifications_admins_enabled",
        ispkg=True,
    ),
    ModuleInfo(
        module_finder=FileFinder(
            "/root_dir/mcat/providers/azure/services/sqlserver/sqlserver_va_emails_notifications_admins_enabled"
        ),
        name="mcat.providers.azure.services.sqlserver.sqlserver_va_emails_notifications_admins_enabled.sqlserver_va_emails_notifications_admins_enabled",
        ispkg=False,
    ),
    ModuleInfo(
        module_finder=FileFinder(
            "/root_dir/mcat/providers/azure/services/postgresql"
        ),
        name="mcat.providers.azure.services.postgresql.postgresql_flexible_server_enforce_ssl_enabled",
        ispkg=True,
    ),
    ModuleInfo(
        module_finder=FileFinder(
            "/root_dir/mcat/providers/azure/services/postgresql/postgresql_flexible_server_enforce_ssl_enabled"
        ),
        name="mcat.providers.azure.services.postgresql.postgresql_flexible_server_enforce_ssl_enabled.postgresql_flexible_server_enforce_ssl_enabled",
        ispkg=False,
    ),
]
...
def mock_list_modules(*_):
    modules = [
        ...
        ModuleInfo(
            module_finder=FileFinder(
                "/root_dir/mcat/providers/azure/services/storage"
            ),
            name="mcat.providers.azure.services.storage.storage_ensure_encryption_with_customer_managed_keys",
            ispkg=True,
        ),
...
class TestCheck:
    ...
    @patch(
        "mcat.lib.check.check.recover_checks_from_provider",
    ...
    @patch("mcat.lib.check.check.list_modules", new=mock_list_modules)
    ...
    @patch("mcat.lib.check.check.walk_packages", new=mock_walk_packages)
    ...
    #     }
    #     with mock.patch(
    #         "mcat.lib.check.check.compliance_specification_dir_path",
    ...
    #     }
    #     with mock.patch(
    #         "mcat.lib.check.check.compliance_specification_dir",
    #         new=f"{pathlib.Path().absolute()}/fixtures",
    #     ):
    #         provider = "aws"
    #         bulk_compliance_frameworks = bulk_load_compliance_frameworks(provider)
    ...
    def test_update_audit_metadata_complete(self):
        from mcat.providers.common.models import Audit_Metadata
    ...
    def test_run_check(self, caplog):
        ...
        with patch("mcat.lib.check.check.execute", return_value=findings):
    ...
    def test_aws_checks_metadata_is_valid(self):
        ...
        base_directory = os.path.abspath(
            os.path.join(
                os.path.dirname(__file__), "../../../", "mcat/providers/aws/services"
            )
        )
    ...
    def test_gcp_checks_metadata_is_valid(self):
        ...
        base_directory = os.path.abspath(
            os.path.join(
                os.path.dirname(__file__), "../../../", "mcat/providers/gcp/services"
            )
        )
        self.verify_metadata_check_id(base_directory)
    ...
    def test_kubernetes_checks_metadata_is_valid(self):
        ...
        base_directory = os.path.abspath(
            os.path.join(
                os.path.dirname(__file__),
                "../../../",
                "mcat/providers/kubernetes/services",
            )
        )
        self.verify_metadata_check_id(base_directory)
