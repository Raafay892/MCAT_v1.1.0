...
from mcat.providers.aws.aws_provider import (
    AwsProvider,
    create_sts_session,
...
from mcat.providers.aws.config import (
    AWS_STS_GLOBAL_ENDPOINT_REGION,
    BOTO3_USER_AGENT_EXTRA,
)
from mcat.providers.aws.lib.arn.models import ARN
from mcat.providers.aws.lib.mutelist.mutelist import AWSMutelist
from mcat.providers.aws.models import (
    AWSAssumeRoleInfo,
    AWSCallerIdentity,
    AWSCredentials,
    AWSMFAInfo,
...
class TestAWSProvider:
    ...
    def test_aws_provider_session_with_mfa(self):
        ...
        with patch(
            "mcat.providers.aws.aws_provider.AwsProvider.__input_role_mfa_token_and_code__",
    ...
    def test_aws_provider_assume_role_with_mfa(self):
        ...
        arguments.session_duration = 900
        arguments.role_session_name = "mcatAssessmentSession"
...
aws:
    ...
    def test_aws_provider_mutelist_none(self):
        ...
        with patch(
            "mcat.providers.aws.aws_provider.get_default_mute_file_path",
            return_value=None,
        ):
    ...
    def test_aws_provider_mutelist_lambda(self):
        ...
        with patch(
            "mcat.providers.aws.lib.mutelist.mutelist.AWSMutelist.get_mutelist_file_from_lambda",
    ...
    def test_aws_provider_mutelist_dynamodb(self):
        ...
        with patch(
            "mcat.providers.aws.lib.mutelist.mutelist.AWSMutelist.get_mutelist_file_from_dynamodb",
            return_value=mutelist["Mutelist"],
        ):
    ...
    def test_get_available_aws_service_regions_with_us_east_1_audited(self):
        ...
        with patch(
            "mcat.providers.aws.aws_provider.parse_json_file",
            return_value={
                "services": {
                    "ec2": {
                        "regions": {
    ...
    def test_set_provider_output_options_aws_no_output_filename(self):
        ...
        with patch(
            "mcat.providers.common.provider.Provider.get_global_provider",
            ...
            assert (
                f"mcat-output-{AWS_ACCOUNT_NUMBER}"
            ...
            #     == f"mcat-output-{AWS_ACCOUNT_NUMBER}-{datetime.today().strftime('%Y%m%d%H%M%S')}"
            # )
    ...
    def test_get_aws_available_regions(self):
        with patch(
            "mcat.providers.aws.aws_provider.read_aws_regions_file",
            return_value={
                "services": {
                    "acm": {
                        "regions": {
